...
var questions = [
	[
		"¿A qué se le llama MP en el campo de la contaminación?",
		"Ministerio público de ambiente",
	...
	[
		"¿Qué efectos tiene el smoke en las personas?",
		"Problemas oculares",
		"Problemas mentales",
		"Problemas de movilidad física",
		"Problemas respiratorios",
		3
	],
	[
		"¿Cuál es la principal característica del transporte ecológico?",
		"Son eléctricos o con energías renovables",
		"Son de colores blanco y verde",
		"Usan agua en vez de gasolina",
		"Solo funcionan con luz solar",
		0
	],
	[
		"¿Cual de estos no es un transporte ecológico?",
		"Scooter eléctrico",
		"Aviones actuales",
		"Bicicletas",
		"Carros eléctricos",
	...
	[
		"¿Qué elemento del medio ambiente es afectado por el transporte contaminante?",
		"La tierra",
		"El agua",
		"El aire",
		"El fuego",
