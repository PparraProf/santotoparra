<?php
    ...
    $mail->AddAddress("pauloc749@yahoo.com");
    ...
    $mail->IsSMTP(); 
    $mail->Host = "ssl://smtp.mail.yahoo.com"; //Servidor de Salida.
    $mail->SMTPAuth = true; 
    $mail->Username = "pauloc749@yahoo.com"; //Correo Electrónico
    $mail->Password = "suzkisv650"; //Contraseña
