...
var questions = [
	[
		"¿A qué se le llama Standby de consumo en Colombia?",
		"Exceso de compras en comercios",
		"Consumo excesivo de agua",
		"Consumo energético de aparatos eléctricos conectados sin usar",
		"Estar en un constante proceso de acción",
		2
	],
	[
		"¿Qué es lo que hace a los equipos eléctricos, consumir menos energía?",
		"El modo ahorro",
		"El alto costo",
		"Su diseño exterior",
		"El tamaño que poseen",
		0
	],
	[
		"¿Cuál de estos no es un factor de consumo de energía en el sector residencial?",
		"Transporte",
		"Iluminación",
		"Refrigeración",
	...
	[
		"¿Cuál de estos no es un consejo de ahorro energético para tu nevera?",
		"Mantén la temperatura ideal de 2 a 6 grados centígrados",
		"Déjala cerca a la lavadora",
		"Ábrela pocas veces",
		"No guardes alimentos calientes",
		1
	],
	[
		"¿Cuál es el aparato eléctrico que gasta más luz, estando apagado?",
		"Microondas",
